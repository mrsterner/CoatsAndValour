...
public class MusketItem extends GeoCockableGunItem implements IGeoDualModel {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private GeoDualModelItemRenderer<MusketItem> renderer = null;

            @Override
            public BuiltinModelItemRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new GeoDualModelItemRenderer<>("musket");
